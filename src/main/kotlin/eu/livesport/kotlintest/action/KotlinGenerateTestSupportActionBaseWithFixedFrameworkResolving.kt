...
/**
 * This class is the same as KotlinGenerateTestSupportActionBase except it
 * resolves the test framework differently and promotes Kotlin Test as Test framework
 */
abstract class KotlinGenerateTestSupportActionBaseWithFixedFrameworkResolving(
